...
| 测试项 | 结论 | 关键数据 |
|---|---|---|
| 量程（黑靶3%反射率）| Pass（摸测） | 20-23m 有效点，随距离递减（254→160点） |
| 量程（白靶>80%）| Pass | 40m 内有效 |
| 测距精度（室内，白靶）| Pass | 20m: 1σ≈0.027m；40m: 1σ≈0.030m；误差±3cm 以内 |
| 阳光场景测距精度（白靶）| Pass | 40m 内满足；黑靶阳光下40m基本无点云 |
...
**来源** | 015_新器件slam采集需求数据分析；飞书群讨论 2026-01-26
