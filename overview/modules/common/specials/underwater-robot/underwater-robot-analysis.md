...
| 本地副本                                      | 原始文件                              | 内容                              |
| ----------------------------------------- | --------------------------------- | ------------------------------- |
| `images/underwater-feishu-proposal.png`   | `Tk2pbRr1qo8KzAxa1aoch2x0n6x.png` | 飞书讨论截图：李哲提出传感器配置+建图方案           |
| `images/underwater-micron-sonar-spec.png` | `TP5mbN21MouPkRxuNnyczJcYnSb.png` | Micron Sonar 参数表（机械扫描声呐，8s/周瓶颈） |
| `images/underwater-sidewall-sketch.png`   | `GtDAbrrYtoov2axPS4ocEvBtniz.png` | 侧壁清洁感知盲区手绘示意图                   |
