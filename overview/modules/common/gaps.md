...
- **链接**：[https://roborock.feishu.cn/drive/folder/CiyDf9iOklMmevduM2vcePMtn5e](https://roborock.feishu.cn/drive/folder/CiyDf9iOklMmevduM2vcePMtn5e)
- **首次提及**：009_技术文档/001_深蓝学院学习资料

### G-002 slamworks 编译流程（飞书 wiki）

- **链接**：[https://roborock.feishu.cn/wiki/QGYCwrSA4iZdslkKBsTcQAi6nxc](https://roborock.feishu.cn/wiki/QGYCwrSA4iZdslkKBsTcQAi6nxc)
- **首次提及**：007_通用文档/001_工具文档/001_上层软件包编译与割草机上机流程 / 003_操作文档/001_割草机仿真和上机流程

### G-003 割草机 SLAM 代码、工具权限整理（飞书 wiki）

- **链接**：[https://roborock.feishu.cn/wiki/DKZbwZEECiUefykVn4Qcwgxknkc](https://roborock.feishu.cn/wiki/DKZbwZEECiUefykVn4Qcwgxknkc)
- **首次提及**：007_通用文档/001_工具文档/001_上层软件包编译与割草机上机流程

### G-004 重装 Ubuntu 后的装机 List（飞书 wiki）

- **链接**：[https://roborock.feishu.cn/wiki/JcQfwDRFei3668kWMuMc8u8HnJd](https://roborock.feishu.cn/wiki/JcQfwDRFei3668kWMuMc8u8HnJd)
- **首次提及**：007_通用文档/001_工具文档/001_上层软件包编译与割草机上机流程

### G-005 Ubuntu 更换本地软件源 APT 文档（飞书 docx）

- **链接**：[https://roborock.feishu.cn/docx/WuEUdTQQSoiN5Mx9lRGcMt8rnlb](https://roborock.feishu.cn/docx/WuEUdTQQSoiN5Mx9lRGcMt8rnlb)
- **首次提及**：007_通用文档/001_工具文档/001_上层软件包编译与割草机上机流程

### G-006 rrprofiler 使用说明（飞书 wiki）

- **链接**：[https://roborock.feishu.cn/wiki/ZELbwsEwIiAFTlkhKV7cyvNznxh](https://roborock.feishu.cn/wiki/ZELbwsEwIiAFTlkhKV7cyvNznxh)
- **首次提及**：008_分享工具/004_内存占用分析

### G-007 视觉实验室装修申请（飞书 wiki）

- **链接**：[https://roborock.feishu.cn/wiki/BBl0wSPKQiYWGDk1au4cml7Fnld](https://roborock.feishu.cn/wiki/BBl0wSPKQiYWGDk1au4cml7Fnld)
- **首次提及**：007_通用文档/005_实验室管理文档/001_视觉实验室需求

### G-008 Versa 割草机 core dump 问题定位与查询（飞书 wiki）

- **链接**：[https://roborock.feishu.cn/wiki/EExSwWXwniLnQOkWuEMcgb3kn1d](https://roborock.feishu.cn/wiki/EExSwWXwniLnQOkWuEMcgb3kn1d)
- **首次提及**：007_通用文档/003_操作文档/003_多线slam上机：环境配置、出包、刷机流程v2.0

### G-009 割草机双目模组资料汇总（飞书 sheets）

- **链接**：[https://roborock.feishu.cn/sheets/TLOrstCK1hMkw0tcTAPc8oXpnEd](https://roborock.feishu.cn/sheets/TLOrstCK1hMkw0tcTAPc8oXpnEd)
- **首次提及**：inbox/0413新增/FLORA,LUMOS,GAIA联合双目评估_2026-04-13-14-36-45/FLORA,LUMOS,GAIA联合双目评估.md
...
### Q-002 联合双目实际不良率与挑选成本缺少量产证据

- **问题**：项目评估文档明确写到目前拿不到联合方案理论和实际不良率，无法确定挑选方案是否可行以及额外人力成本
- **建议确认人**：采购 / TPM / 结构 / 供应商质量
- **优先级**：高

### Q-003 20cm 盲区样品对导航/感知/定位的实际影响仍待样机验证

- **问题**：理论分析文档已给出跨领域初判，但导航、感知、定位的实际影响结论尚缺 `20cm` 盲区样品 AB 测试，尤其缺少定位成功率与远场特征可见性数据
- **建议确认人**：导航 / 感知 / 视觉定位负责人
- **优先级**：高
